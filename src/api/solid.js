...
export const context = {
  "@context": {
    ...
    "foaf": "http://xmlns.com/foaf/0.1/",
    "accessList": `${uris.acl}trustedApp`,
    "mode": `${uris.acl}mode`,
    ...
    "inbox": `${uris.ldp}inbox`,
    "rdftype": "http://www.w3.org/1999/02/22-rdf-syntax-ns#type",
    "currentProject": `${uris.foaf}currentProject`,
    "interests": "foaf:topic_interest",
    "Rana": { "@id": "https://rsaniei.inrupt.net/profile/card#me" },
    "POSTS": { "@id": "https://rsaniei.inrupt.net/public/posts/#" }
  }
};

const comunicaConfig = {
  sources: [
    { type: "file", value: "https://rsaniei.inrupt.net/profile/card#me" }
  ],
};
